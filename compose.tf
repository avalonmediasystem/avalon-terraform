...
resource "aws_instance" "compose" {
  ...
  user_data = base64encode(templatefile("scripts/compose-init.sh", {
    ...
    db_fcrepo_address = "${module.db_fcrepo.this_db_instance_address}"
    db_fcrepo_username = "${module.db_fcrepo.this_db_instance_username}"
    db_fcrepo_password = "${module.db_fcrepo.this_db_instance_password}"
    db_fcrepo_port = "${module.db_fcrepo.this_db_instance_port}"
    db_avalon_address = "${module.db_avalon.this_db_instance_address}"
    db_avalon_username = "${module.db_avalon.this_db_instance_username}"
    db_avalon_password = "${module.db_avalon.this_db_instance_password}"
